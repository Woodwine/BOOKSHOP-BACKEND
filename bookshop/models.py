...
class Book(models.Model):
    ...
    author = models.ForeignKey(Author, related_name='books_author', on_delete=models.CASCADE, verbose_name='Автор')
    publishing = models.ForeignKey(Publishing, related_name='publishing_books', on_delete=models.SET_NULL,
                                   null=True, verbose_name='Издательство')
...
class Order(models.Model):
    ...
    customer = models.ForeignKey(User, related_name='customer_orders', on_delete=models.CASCADE, verbose_name='Заказчик')
...
class Comments(models.Model):
    ...
    book = models.ForeignKey(Book, related_name='book_comments', on_delete=models.CASCADE, verbose_name='Название книги')
